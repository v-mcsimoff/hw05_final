# Generated by Django 2.2.16 on 2023-02-07 20:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(help_text='Обязательное поле', verbose_name='Текст поста')),
                ...
                ('group', models.ForeignKey(blank=True, help_text='Выберите группу или оставьте пустым', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='posts.Group', verbose_name='Группа')),
            ],
            options={
                'verbose_name': 'пост',
